...
// class theme_academi_transmuted_custom_menu_item extends custom_menu_item {
...
//             try {
//                 $this->text = get_string($matches[1], 'theme_academi');
//             } catch (Exception $e) {
//                 $this->text = $matches[1];
//             }
//         }
...
//             try {
//                 $this->title = get_string($matches[1], 'theme_academi');
//             } catch (Exception $e) {
