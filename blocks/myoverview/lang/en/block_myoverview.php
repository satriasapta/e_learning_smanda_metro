...
$string['all'] = 'All';
$string['addtofavourites'] = 'Star this class';
...
$string['aria:controls'] = 'class overview controls';
$string['aria:courseactions'] = 'Actions for current course';
$string['aria:coursesummary'] = 'class summary text:';
...
$string['availablegroupings_desc'] = 'class filters which are available for selection by users. If none are selected, all classs will be displayed.';
$string['card'] = 'Card';
$string['cards'] = 'Cards';
$string['courseprogress'] = 'class progress:';
$string['completepercent'] = '{$a}% complete';
$string['customfield'] = 'Custom field';
$string['customfiltergrouping'] = 'Field to use';
$string['customfiltergrouping_nofields'] = 'This option requires a class custom field to be set up and visible to everyone.';
$string['displaycategories'] = 'Display categories';
$string['displaycategories_help'] = 'Display the class category on dashboard class items including cards, list items and summary items.';
$string['favourites'] = 'Starred';
$string['future'] = 'Future';
$string['inprogress'] = 'In progress';
$string['lastaccessed'] = 'Last accessed';
$string['layouts'] = 'Available layouts';
$string['layouts_help'] = 'Class List layouts which are available for selection by users. If none are selected, the card layout will be used.';
$string['list'] = 'List';
$string['myoverview:myaddinstance'] = 'Add a new Class List block to Dashboard';
$string['nocustomvalue'] = 'No {$a}';
$string['past'] = 'Past';
$string['pluginname'] = 'Class List';
$string['privacy:metadata:overviewsortpreference'] = 'The Class List block sort preference.';
$string['privacy:metadata:overviewviewpreference'] = 'The Class List block view preference.';
$string['privacy:metadata:overviewgroupingpreference'] = 'The Class List block grouping preference.';
$string['privacy:metadata:overviewpagingpreference'] = 'The Class List block paging preference.';
